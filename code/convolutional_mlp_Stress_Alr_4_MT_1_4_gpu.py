...
#    print (x.shahpe)
    ...
    layer3 = LogisticRegression(input=layer24.output, n_in=nhu1, n_out=n_out)
    ...
    params = layer3.params + layer24.params + layer23.params + layer22.params + layer2.params + layer1H.params + layer0.params
