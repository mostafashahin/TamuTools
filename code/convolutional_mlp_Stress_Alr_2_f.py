...
class LeNetConvPoolLayer(object):
    ...
    def __init__(self, rng, input, filter_shape, image_shape, poolsize=(p1, p1)):
        """
...
def evaluate_lenet5(learning_rate=0.1, n_epochs=200,
    ...
    layer0 = LeNetConvPoolLayer(rng, input=layer0_input,
            ...
            filter_shape=(nkerns[0], 2, fsx, fsy), poolsize=(p1, p1))
    cl2x = (27 - fsx + 1)/p1
    cl2y = (10 - fsy + 1)/p1
    ...
    layer1 = LeNetConvPoolLayer(rng, input=layer0.output,
            ...
            filter_shape=(nkerns[1], nkerns[0], fsx, fsy), poolsize=(p2, p2))
