...
def evaluate_lenet5(learning_rate=0.1, n_epochs=200,
    ...
    layer0 = LeNetConvPoolLayer(rng, input=layer0_input,
            ...
            filter_shape=(nkerns[0], 2, 5, 2), poolsize=(2, 2))
    ...
    layer1 = LeNetConvPoolLayer(rng, input=layer0.output,
            ...
            filter_shape=(nkerns[1], nkerns[0], 5, 2), poolsize=(2, 2))
    ...
    layer2 = HiddenLayer(rng, input=layer2_inputT, n_in=(nkerns[1] * 3 * 1)+12,
