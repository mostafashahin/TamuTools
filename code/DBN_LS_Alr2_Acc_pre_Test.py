...
def test_DBN(finetune_lr=lr, pretraining_epochs=100,
    ...
    dbn = DBN(numpy_rng=numpy_rng, n_ins=n_inp,
              ...
              n_outs=n_out)
    #Load params
    fbestParam = gzip.open('Temp/Bestparam_AllData_MT_25_2_CAS.pkl.gz_6_600_2.pkl.gz','rb')
...
#                          ' ran for %.2fm' % ((end_time - start_time) / 60.))
    ...
    fbestParam.close()
    OF = open(outFile,'a')
    print(DataSet, lr ,n_hls, n_hus, n_out, batchSize, NOfepoch, n_inp, outFile, test_score * 100., acc1 * 100., acc2 * 100., acc3 * 100, acc4 * 100, I11[0].size, I12[0].size, I13[0].size, I14[0].size, I21[0].size, I22[0].size, I23[0].size, I24[0].size, I31[0].size, I32[0].size, I33[0].size, I34[0].size, I41[0].size, I42[0].size, I43[0].size, I44[0].size, file = OF)
