...
#                          ' ran for %.2fm' % ((end_time - start_time) / 60.))
    ...
    #                                          / 60.))
    OF = open(outFile,'a')
    print(DataSet, lr ,n_hls, n_hus, n_out, batchSize, NOfepoch, outFile, test_score * 100., acc1 * 100., acc2 * 100., acc3 * 100., I11[0].size, I12[0].size, I13[0].size, I21[0].size, I22[0].size, I23[0].size, I31[0].size, I32[0].size, I33[0].size, file = OF)
