...
sTrainingList = 'TrainingFeatMask_40.scp'
sValidList = 'ValidFeatMask_40.scp'
sTestingList = 'TestingFeatMask_40.scp'
...
#
 ...
 #                         ' ran for %.2fm' % ((end_time - start_time) / 60.)))
    ...
    if not os.path.isdir('Temp'):
        os.makedirs('Temp')
    fbestParam = gzip.open('Temp/Bestparam_'+str(iAttributeIndx)+'_'+str(iNumFrames)+'_'+str(n_hls)+'_'+str(n_hus)+'_'+str(n_out)+'_'+str(iFeatSize)+'.pkl.gz','wb')
    fbestP = open('Temp/Bestp_'+str(iAttributeIndx)+'_'+str(iNumFrames)+'_'+str(n_hls)+'_'+str(n_hus)+'_'+str(n_out)+'_'+str(iFeatSize)+'.txt','w')
