...
#    print (x.shahpe)
    ...
    cl2x = (nFB - fsx + 1)/p
    cl2y = (nFs - fsy + 1)/1
    print(layer1H_input.shape[0])
    layer1H = HiddenLayer(rng, input = layer1H_input, n_in = 27, n_out = nhus, activation = T.tanh)
    ...
    params = layer3.params + layer2.params +layer22.params + layer1H.params + layer0.params
