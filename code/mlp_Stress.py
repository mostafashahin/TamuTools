...
class MLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        self.y_pred = self.logRegressionLayer.ypred
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
             dataset='AllData_M_3.pkl.gz', batch_size=20, n_hidden=500):
    """
   ...
   """
    ...
    #yPred = theano.function([x],classifier.y_pred)
        ...
        for minibatch_index in xrange(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    yPP = classifier.y_pred()#yPred(test_set_x.get_value())
                    yP = yPP.owner.inputs[0].get_value()
                    print yP.type
                    ...
                    print(('     epoch %i, minibatch %i/%i, test error of '
                          ...
                          (epoch, minibatch_index + 1, n_train_batches,
                           test_score * 100., acc1 * 100., acc2 * 100., acc3 * 100, I11[0].size, I12[0].size, I13[0].size, I21[0].size, I22[0].size, I23[0].size, I31[0].size, I32[0].size, I33[0].size))
                    #print(('     epoch %i, minibatch %i/%i, test error of '
                           #'best model %f %%') %
                          #(epoch, minibatch_index + 1, n_train_batches,
                           #test_score * 100.))
